...
public class OneNote extends AppCompatActivity  implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap_OneNote.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).title("bu 1!"));
        ...
        //mMap_OneNote.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latitude,longitude), zoomLevel));

        mMap_OneNote.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            @Override
            public void onMyLocationChange(Location arg0) {


                //mMap_OneNote.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).title("It's Me!"));
